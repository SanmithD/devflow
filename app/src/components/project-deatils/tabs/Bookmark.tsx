...
import { BookmarkMessages } from "../types/Bookmark_type";

interface ArchiveProps {
  isActive: boolean;
}

function Bookmark({ isActive }: ArchiveProps) {
  ...
  const bookmarked = data?.pages.flatMap((page) => page.messages) ?? [];
  ...
  const handleDeleteAll = async () => {
    ...
    try {
      ...
      await axios.delete("/api/projects/bookmark");
