...
function Signup() {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      setLoading(true);
      await axios.post("/api/auth/send_otp", { email: formData.email });
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0f] px-4">
      ...
      <div className="w-full max-w-[420px] bg-[#111118] border border-white/[0.07] rounded-[20px] px-8 shadow-[0_0_60px_rgba(99,91,255,0.08)]">
        ...
        <button
          ...
          disabled={loading}
          className="w-full h-[50px] bg-gradient-to-r from-violet-600 to-purple-500 text-white rounded-[10px] text-sm font-medium tracking-wide transition-all duration-200 hover:opacity-90 hover:-translate-y-px active:translate-y-0 disabled:opacity-50 disabled:cursor-default mb-4"
        >
